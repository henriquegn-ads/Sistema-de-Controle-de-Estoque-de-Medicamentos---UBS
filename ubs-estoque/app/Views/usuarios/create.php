        ...
        <main class="main-content">
            <div class="page-header">
                <div>
                    ...
                    <p class="page-subtitle">Cadastre um usuário e defina seu perfil.</p>
                </div>
            </div>
            ...
            <section class="form-card">
                <form method="POST" action="/usuarios/store">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="nome" name="nome" value="<?= htmlspecialchars($_POST['nome'] ?? '') ?>" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="perfil_id" name="perfil_id" required>
                            ...
                            <?php foreach ($perfis as $perfil): ?>
                                <option value="<?= (int) $perfil['id'] ?>" <?= ((int) ($_POST['perfil_id'] ?? 0) === (int) $perfil['id']) ? 'selected' : '' ?>>
